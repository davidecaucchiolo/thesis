...
for l,j in xVals:
    ...
    axs1.plot(xVals[l,j],[v/l for v in der2(yVals[l,j],hVals)],nextShape()+"-" if j==-1 else nextShape()+'--',label="FM" if j==-1. else "AFM")
...
fig.subplots_adjust(left=.10, bottom=.13, right=.962, top=.9, wspace=0.4)
